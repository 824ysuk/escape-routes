...
| 3 | [本番でしか起きないバグを調査したい](cases/03-production-only-bug/README.md) | local で再現できない | 10 |
...
- 事例 3: [Brendan Gregg — Systems Performance (2nd ed)](https://www.brendangregg.com/sysperfbook.html) / [Google SRE Book](https://sre.google/sre-book/table-of-contents/) / [py-spy](https://github.com/benfred/py-spy) / [async-profiler](https://github.com/async-profiler/async-profiler) / [Argo Rollouts AnalysisTemplate](https://argoproj.github.io/argo-rollouts/features/analysis/) / [OpenTelemetry OBI announce](https://opentelemetry.io/blog/2025/obi-announcing-first-release/) / [OBI setup (Docker)](https://opentelemetry.io/docs/zero-code/obi/setup/docker/) / [OBI setup (Kubernetes)](https://opentelemetry.io/docs/zero-code/obi/setup/kubernetes/) / [Grafana Beyla donation](https://grafana.com/blog/opentelemetry-ebpf-instrumentation-beyla-donation/) / [Grafana Pyroscope](https://github.com/grafana/pyroscope) / [Pyroscope SDK docs](https://grafana.com/docs/pyroscope/latest/configure-client/) / [OpenTelemetry eBPF profiler](https://github.com/open-telemetry/opentelemetry-ebpf-profiler) / [Polar Signals](https://www.polarsignals.com/) / [Parca (GitHub)](https://github.com/parca-dev/parca) / [parca-agent (GitHub)](https://github.com/parca-dev/parca-agent) / [LitmusChaos](https://litmuschaos.io/) / [LitmusChaos docs](https://docs.litmuschaos.io/) / [CNCF — Litmus project](https://www.cncf.io/projects/litmus/) / [pod-delete experiment](https://litmuschaos.github.io/litmus/experiments/categories/pods/pod-delete/) / [LitmusChaos GitHub](https://github.com/litmuschaos/litmus)
...
- 事例 3: [py-spy](https://github.com/benfred/py-spy) / [async-profiler](https://github.com/async-profiler/async-profiler) / [tcpdump](https://www.tcpdump.org/) / [strace](https://strace.io/) / [Argo Rollouts](https://argoproj.github.io/argo-rollouts/) / [delve](https://github.com/go-delve/delve) / [OBI (otel/ebpf-instrument)](https://github.com/grafana/beyla) / [Pyroscope](https://github.com/grafana/pyroscope) / [pyroscope-go](https://github.com/grafana/pyroscope-go) / [@pyroscope/nodejs](https://github.com/grafana/pyroscope-nodejs) / [OTel eBPF profiler](https://github.com/open-telemetry/opentelemetry-ebpf-profiler) / [Parca](https://github.com/parca-dev/parca) / [parca-agent](https://github.com/parca-dev/parca-agent) / [Polar Signals](https://www.polarsignals.com/) / [LitmusChaos](https://github.com/litmuschaos/litmus)
